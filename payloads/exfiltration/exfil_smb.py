#!/usr/bin/env python3
"""
DaRkb0x Payload -- SMB Exfiltration
=======================================
Author: 7h30th3r0n3

Two-mode SMB exfiltration tool:
  Mode 1 (Serve): Start an SMB share on the Pi serving /root/DaRkb0x/loot/
...
LOOT_DIR = "/root/DaRkb0x/loot/SMBExfil"
CONFIG_DIR = "/root/DaRkb0x/config/exfil_smb"
