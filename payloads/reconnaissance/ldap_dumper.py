...
Saves structured JSON to /root/DaRkb0x/loot/LDAPDump/.
...
# Constants
# ---------------------------------------------------------------------------
LOOT_DIR = "/root/DaRkb0x/loot/LDAPDump"
CONFIG_DIR = "/root/DaRkb0x/config/ldap_dumper"
