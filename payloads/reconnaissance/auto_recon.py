#!/usr/bin/env python3
"""
DaRkb0x Payload -- Automated Reconnaissance (Shark Jack Style)
================================================================
Author: 7h30th3r0n3
...
Setup / Prerequisites:
  - Optional: Discord webhook in /root/DaRkb0x/discord_webhook.txt
...
Sequence:
  ...
  5. Save JSON loot to /root/DaRkb0x/loot/AutoRecon/
...
# Constants
# ---------------------------------------------------------------------------
LOOT_DIR = "/root/DaRkb0x/loot/AutoRecon"
