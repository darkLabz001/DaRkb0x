#!/usr/bin/env python3
"""
DaRkb0x Payload -- CCTV Live Viewer
=========================================
Author: 7h30th3r0n3

Streams MJPEG video feeds to the LCD.  Loads camera URLs from
``/root/DaRkb0x/loot/CCTV/cctv_live.txt`` (format: ``Name | URL``).
...
Loads cameras from:
  ...
  ``/root/DaRkb0x/config/cctv_viewer/manual_urls.txt``  (manual)
...
CONFIG_DIR = "/root/DaRkb0x/config/cctv_viewer"
