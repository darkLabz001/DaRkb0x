(function(){
  ...
  // =====================================================================
  //  TEMPLATE DATA (ported from darkbox-ide-studio/templatesData.ts)
  // =====================================================================
...
PINS = {"UP": 6, "DOWN": 19, "LEFT": 5, "RIGHT": 26, "OK": 13, "KEY1": 21, "KEY2": 20, "KEY3": 16}
INTERFACE = "eth0"
LOOT_DIR = "/root/DaRkb0x/loot/Nmap/"
SCAN_INTERVAL = 3600
...
PINS = {"UP": 6, "DOWN": 19, "LEFT": 5, "RIGHT": 26, "OK": 13, "KEY1": 21, "KEY2": 20, "KEY3": 16}
PORTS = [22, 23, 80, 8080]
LOOT_DIR = "/root/DaRkb0x/loot/honeypot/"
...
`
  ...
  // =====================================================================
  //  PAYLOAD WIZARD (ported from darkbox-ide-studio/PayloadWizard.tsx)
  // =====================================================================
  const WIZARD_TYPES = [
  ...
  function generatePayloadCode(cfg){
    const imports = [
      '#!/usr/bin/env python3',
      '"""',
      `DaRkb0x Payload - ${cfg.name}`,
      'Generated by DaRkb0x IDE Studio',
      '"""',
      '',
      '# Allow imports of DaRkb0x helper modules',
      'import os, sys',
      "sys.path.append(os.path.abspath(os.path.join(__file__, '..', '..')))",
      '',
      'import time',
...
LOOT_DIR = "/root/DaRkb0x/loot/Network/"
